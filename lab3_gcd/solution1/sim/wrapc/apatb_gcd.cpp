...
// wrapc file define: "c"
#define AUTOTB_TVOUT_c  "../tv/cdatafile/c.gcd.autotvout_c.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "c"
#define AUTOTB_TVOUT_PC_c  "../tv/rtldatafile/rtl.gcd.autotvout_c.dat"
					...
					// bitslice(31, 0)
					{
						...
						// celement: c(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								// sub_1st_elem           : 0
								// ori_name_1st_elem      : c
								// output_left_conversion : c
								// output_type_conversion : (c_lv0_0_0_1[hls_map_index]).to_uint64()
								if (&(c) != NULL) // check the null address if the c port is array or others
								{
									c = (c_lv0_0_0_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
